...
var inputvue_type_template_id_759e47f4_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser_prod["n" /* createStaticVNode */])("<h2 id=\"input\"><a class=\"header-anchor\" href=\"#input\">¶</a> Input</h2><p>Input data using mouse or keyboard.</p><div class=\"warning\"><p>Input is a controlled component, it <strong>always shows Vue binding value</strong>.</p><p>Under normal circumstances, <code>input</code> event should be handled. Its handler should update component&#39;s binding value (or use <code>v-model</code>). Otherwise, input box&#39;s value will not change.</p><p>Do not support <code>v-model</code> modifiers.</p></div><h3 id=\"basic-usage\"><a class=\"header-anchor\" href=\"#basic-usage\">¶</a> Basic usage</h3>", 4);

var inputvue_type_template_id_759e47f4_hoisted_6 = /*#__PURE__*/Object(vue_esm_browser_prod["p" /* createVNode */])("pre", null, [/*#__PURE__*/Object(vue_esm_browser_prod["p" /* createVNode */])("code", {
  class: "html"
...
function inputvue_type_template_id_759e47f4_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser_prod["H" /* openBlock */])(), Object(vue_esm_browser_prod["k" /* createBlock */])("section", inputvue_type_template_id_759e47f4_hoisted_1, [inputvue_type_template_id_759e47f4_hoisted_2, Object(vue_esm_browser_prod["p" /* createVNode */])(_component_demo_block, null, {
