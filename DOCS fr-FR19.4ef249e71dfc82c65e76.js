...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/fr-FR/date-picker.md?vue&type=template&id=13806154

const date_pickervue_type_template_id_13806154_hoisted_1 = {
  class: "content element-doc"
};

const date_pickervue_type_template_id_13806154_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser_prod["createTextVNode"])("DatePicker ");

const date_pickervue_type_template_id_13806154_hoisted_3 = /*#__PURE__*/Object(vue_esm_browser_prod["createElementVNode"])("p", null, "Utilisez DatePicker pour les champs de dates.", -1);

const date_pickervue_type_template_id_13806154_hoisted_4 = /*#__PURE__*/Object(vue_esm_browser_prod["createTextVNode"])("Entrez la date ");

const date_pickervue_type_template_id_13806154_hoisted_5 = /*#__PURE__*/Object(vue_esm_browser_prod["createElementVNode"])("p", null, "L'unité de base du DatePicker est le jour.", -1);

const date_pickervue_type_template_id_13806154_hoisted_6 = /*#__PURE__*/Object(vue_esm_browser_prod["createElementVNode"])("div", null, [/*#__PURE__*/Object(vue_esm_browser_prod["createElementVNode"])("p", null, [/*#__PURE__*/Object(vue_esm_browser_prod["createTextVNode"])("L'unité est déterminée par l'attribut "), /*#__PURE__*/Object(vue_esm_browser_prod["createElementVNode"])("code", null, "type"), /*#__PURE__*/Object(vue_esm_browser_prod["createTextVNode"])(". You can enable quick options via "), /*#__PURE__*/Object(vue_esm_browser_prod["createElementVNode"])("code", null, "shortcuts"), /*#__PURE__*/Object(vue_esm_browser_prod["createTextVNode"])(" property. L'état désactivé est contrôlé par "), /*#__PURE__*/Object(vue_esm_browser_prod["createElementVNode"])("code", null, "disabledDate"), /*#__PURE__*/Object(vue_esm_browser_prod["createTextVNode"])(" qui est une fonction.")])], -1);

const date_pickervue_type_template_id_13806154_hoisted_7 = /*#__PURE__*/Object(vue_esm_browser_prod["createElementVNode"])("pre", null, [/*#__PURE__*/Object(vue_esm_browser_prod["createElementVNode"])("code", {
  class: "html"
}, "<template>\n  <div class=\"block\">\n    <span class=\"demonstration\">Défaut</span>\n    <el-date-picker\n      v-model=\"value1\"\n      type=\"date\"\n      placeholder=\"Choississez un jour\">\n    </el-date-picker>\n  </div>\n  <div class=\"block\">\n    <span class=\"demonstration\">Picker avec raccourcis</span>\n    <el-date-picker\n      v-model=\"value2\"\n      type=\"date\"\n      placeholder=\"Choississez un jour\"\n      :disabled-date=\"disabledDate\"\n      :shortcuts=\"shortcuts\"\n    >\n    </el-date-picker>\n  </div>\n</template>\n\n<script>\n  export default {\n    data() {\n      return {\n        disabledDate(time) {\n          return time.getTime() > Date.now()\n        },\n        shortcuts: [{\n          text: 'Today',\n          value: new Date(),\n        }, {\n          text: 'Yesterday',\n          value: () => {\n            const date = new Date()\n            date.setTime(date.getTime() - 3600 * 1000 * 24)\n            return date\n          },\n        }, {\n          text: 'A week ago',\n          value: () => {\n            const date = new Date()\n            date.setTime(date.getTime() - 3600 * 1000 * 24 * 7)\n            return date\n          },\n        }],\n        value1: '',\n        value2: '',\n      };\n    }\n  };\n</script>\n<!--\n<setup>\n\n  import { defineComponent, reactive, toRefs } from 'vue';\n\n  export default defineComponent({\n    setup() {\n      const state = reactive({\n        disabledDate(time) {\n          return time.getTime() > Date.now();\n        },\n        shortcuts: [\n          {\n            text: 'Today',\n            value: new Date(),\n          },\n          {\n            text: 'Yesterday',\n            value: () => {\n              const date = new Date();\n              date.setTime(date.getTime() - 3600 * 1000 * 24);\n              return date;\n            },\n          },\n          {\n            text: 'A week ago',\n            value: () => {\n              const date = new Date();\n              date.setTime(date.getTime() - 3600 * 1000 * 24 * 7);\n              return date;\n            },\n          },\n        ],\n        value1: '',\n        value2: '',\n      });\n\n      return {\n        ...toRefs(state),\n      };\n    },\n  });\n\n</setup>\n-->\n")], -1);

const date_pickervue_type_template_id_13806154_hoisted_8 = /*#__PURE__*/Object(vue_esm_browser_prod["createTextVNode"])("Autres unités ");

const date_pickervue_type_template_id_13806154_hoisted_9 = /*#__PURE__*/Object(vue_esm_browser_prod["createElementVNode"])("p", null, "Vous pouvez sélectionner une semaine, un mois, une année ou plusieurs dates en ajoutant des options grâce aux attributs.", -1);

const date_pickervue_type_template_id_13806154_hoisted_10 = /*#__PURE__*/Object(vue_esm_browser_prod["createElementVNode"])("pre", null, [/*#__PURE__*/Object(vue_esm_browser_prod["createElementVNode"])("code", {
  class: "html"
...
function date_pickervue_type_template_id_13806154_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser_prod["openBlock"])(), Object(vue_esm_browser_prod["createElementBlock"])("section", date_pickervue_type_template_id_13806154_hoisted_1, [Object(vue_esm_browser_prod["createVNode"])(_component_app_heading, {
    id: "datepicker",
    content: "DatePicker",
    href: "#datepicker",
    level: "2"
  }, {
    default: Object(vue_esm_browser_prod["withCtx"])(() => [date_pickervue_type_template_id_13806154_hoisted_2, Object(vue_esm_browser_prod["createVNode"])(_component_app_link, {
      class: "header-anchor",
      href: "#datepicker"
    })]),
    _: 1
  }), date_pickervue_type_template_id_13806154_hoisted_3, Object(vue_esm_browser_prod["createVNode"])(_component_app_heading, {
    id: "entrez-la-date",
    content: "Entrez la date",
    href: "#entrez-la-date",
    level: "3"
  }, {
    default: Object(vue_esm_browser_prod["withCtx"])(() => [date_pickervue_type_template_id_13806154_hoisted_4, Object(vue_esm_browser_prod["createVNode"])(_component_app_link, {
      class: "header-anchor",
      href: "#entrez-la-date"
    })]),
    _: 1
  }), date_pickervue_type_template_id_13806154_hoisted_5, Object(vue_esm_browser_prod["createVNode"])(_component_demo_block, null, {
    source: Object(vue_esm_browser_prod["withCtx"])(() => [Object(vue_esm_browser_prod["createVNode"])(_component_element_demo0)]),
    highlight: Object(vue_esm_browser_prod["withCtx"])(() => [date_pickervue_type_template_id_13806154_hoisted_7]),
    default: Object(vue_esm_browser_prod["withCtx"])(() => [date_pickervue_type_template_id_13806154_hoisted_6]),
    _: 1
    ...
    default: Object(vue_esm_browser_prod["withCtx"])(() => [date_pickervue_type_template_id_13806154_hoisted_8, Object(vue_esm_browser_prod["createVNode"])(_component_app_link, {
      class: "header-anchor",
      href: "#autres-unites"
    })]),
    _: 1
  }), date_pickervue_type_template_id_13806154_hoisted_9, Object(vue_esm_browser_prod["createVNode"])(_component_demo_block, null, {
    source: Object(vue_esm_browser_prod["withCtx"])(() => [Object(vue_esm_browser_prod["createVNode"])(_component_element_demo1)]),
    highlight: Object(vue_esm_browser_prod["withCtx"])(() => [date_pickervue_type_template_id_13806154_hoisted_10]),
    _: 1
  }), Object(vue_esm_browser_prod["createVNode"])(_component_app_heading, {
    id: "plage-de-dates",
...
// CONCATENATED MODULE: ./website/docs/fr-FR/date-picker.md?vue&type=template&id=13806154
...
date_pickervue_type_script_lang_ts.render = date_pickervue_type_template_id_13806154_render
