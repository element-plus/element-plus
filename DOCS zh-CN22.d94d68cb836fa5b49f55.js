...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/zh-CN/drawer.md?vue&type=template&id=228ce1ae

var drawervue_type_template_id_228ce1ae_hoisted_1 = {
  class: "content element-doc"
};

var drawervue_type_template_id_228ce1ae_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser["m" /* createStaticVNode */])("<h2 id=\"drawer-chou-ti\"><a class=\"header-anchor\" href=\"#drawer-chou-ti\">¶</a> Drawer 抽屉</h2><p>有些时候, <code>Dialog</code> 组件并不满足我们的需求, 比如你的表单很长, 亦或是你需要临时展示一些文档, <code>Drawer</code> 拥有和 <code>Dialog</code> 几乎相同的 API, 在 UI 上带来不一样的体验.</p><div class=\"tip\"><p>因为 Vue 提供了 <code>v-model</code> 的原生支持，所以以前的 <code>visible.sync</code> 已经不再适用，请使用 <code>v-model=&quot;visibleBinding&quot;</code> 的表达式来绑定是否显示抽屉组件</p></div><h3 id=\"ji-ben-yong-fa\"><a class=\"header-anchor\" href=\"#ji-ben-yong-fa\">¶</a> 基本用法</h3><p>呼出一个临时的侧边栏, 可以从多个方向呼出</p>", 5);
...
function drawervue_type_template_id_228ce1ae_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["G" /* openBlock */])(), Object(vue_esm_browser["j" /* createBlock */])("section", drawervue_type_template_id_228ce1ae_hoisted_1, [drawervue_type_template_id_228ce1ae_hoisted_2, Object(vue_esm_browser["o" /* createVNode */])(_component_demo_block, null, {
...
// CONCATENATED MODULE: ./website/docs/zh-CN/drawer.md?vue&type=template&id=228ce1ae
...
drawervue_type_script_lang_ts.render = drawervue_type_template_id_228ce1ae_render
