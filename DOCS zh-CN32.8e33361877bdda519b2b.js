...
var inputvue_type_template_id_dad4f91a_hoisted_2 = /*#__PURE__*/Object(vue_esm_browser["m" /* createStaticVNode */])("<h2 id=\"input-shu-ru-kuang\"><a class=\"header-anchor\" href=\"#input-shu-ru-kuang\">¶</a> Input 输入框</h2><p>通过鼠标或键盘输入字符</p><div class=\"warning\"><p>Input 为受控组件，它<strong>总会显示 Vue 绑定值</strong>。</p><p>通常情况下，应当处理 <code>input</code> 事件，并更新组件的绑定值（或使用<code>v-model</code>）。否则，输入框内显示的值将不会改变。</p><p>不支持 <code>v-model</code> 修饰符。</p></div><h3 id=\"ji-chu-yong-fa\"><a class=\"header-anchor\" href=\"#ji-chu-yong-fa\">¶</a> 基础用法</h3>", 4);

var inputvue_type_template_id_dad4f91a_hoisted_6 = /*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("pre", null, [/*#__PURE__*/Object(vue_esm_browser["o" /* createVNode */])("code", {
  class: "html"
...
function inputvue_type_template_id_dad4f91a_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser["G" /* openBlock */])(), Object(vue_esm_browser["j" /* createBlock */])("section", inputvue_type_template_id_dad4f91a_hoisted_1, [inputvue_type_template_id_dad4f91a_hoisted_2, Object(vue_esm_browser["o" /* createVNode */])(_component_demo_block, null, {
