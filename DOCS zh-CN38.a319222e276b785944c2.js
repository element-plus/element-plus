...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/dist/templateLoader.js??ref--6!./node_modules/vue-loader/dist??ref--2-0!./website/md-loader!./website/docs/zh-CN/message-box.md?vue&type=template&id=22299347

var message_boxvue_type_template_id_22299347_hoisted_1 = {
  class: "content element-doc"
};

var _hoisted_2 = /*#__PURE__*/Object(vue_esm_browser_prod["n" /* createStaticVNode */])("<h2 id=\"messagebox-dan-kuang\"><a class=\"header-anchor\" href=\"#messagebox-dan-kuang\">¶</a> MessageBox 弹框</h2><p>模拟系统的消息提示框而实现的一套模态对话框组件，用于消息提示、确认消息和提交内容。</p><div class=\"tip\"><p>从场景上说，MessageBox 的作用是美化系统自带的 <code>alert</code>、<code>confirm</code> 和 <code>prompt</code>，因此适合展示较为简单的内容。如果需要弹出较为复杂的内容，请使用 Dialog。</p></div><h3 id=\"xiao-xi-ti-shi\"><a class=\"header-anchor\" href=\"#xiao-xi-ti-shi\">¶</a> 消息提示</h3><p>当用户进行操作时会被触发，该对话框中断用户操作，直到用户确认知晓后才可关闭。</p>", 5);
...
}, "¶"), /*#__PURE__*/Object(vue_esm_browser_prod["o" /* createTextVNode */])(" 确认消息")], -1);
...
}, "¶"), /*#__PURE__*/Object(vue_esm_browser_prod["o" /* createTextVNode */])(" 提交内容")], -1);
...
var _hoisted_21 = /*#__PURE__*/Object(vue_esm_browser_prod["n" /* createStaticVNode */])("<div class=\"tip\"><p>弹出层的内容可以是 <code>VNode</code>，所以我们能把一些自定义组件传入其中。每次弹出层打开后，Vue 会对新老 <code>VNode</code> 节点进行比对，然后将根据比较结果进行最小单位地修改视图。这也许会造成弹出层内容区域的组件没有重新渲染，例如 <a href=\"https://github.com/ElemeFE/element/issues/8931\">#8931</a>。当这类问题出现时，解决方案是给 <code>VNode</code> 加上一个不相同的 key，参考<a href=\"https://jsfiddle.net/zhiyang/ezmhq2ef/\">这里</a>。</p></div><h3 id=\"shi-yong-html-pian-duan\"><a class=\"header-anchor\" href=\"#shi-yong-html-pian-duan\">¶</a> 使用 HTML 片段</h3><p><code>message</code> 属性支持传入 HTML 片段。</p>", 3);
...
var _hoisted_31 = /*#__PURE__*/Object(vue_esm_browser_prod["p" /* createVNode */])("h3", {
  ...
  class: "header-anchor",
  href: "#ju-zhong-bu-ju"
}, "¶"), /*#__PURE__*/Object(vue_esm_browser_prod["o" /* createTextVNode */])(" 居中布局")], -1);

var _hoisted_32 = /*#__PURE__*/Object(vue_esm_browser_prod["p" /* createVNode */])("p", null, "内容支持居中布局", -1);
...
function message_boxvue_type_template_id_22299347_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return Object(vue_esm_browser_prod["H" /* openBlock */])(), Object(vue_esm_browser_prod["k" /* createBlock */])("section", message_boxvue_type_template_id_22299347_hoisted_1, [_hoisted_2, Object(vue_esm_browser_prod["p" /* createVNode */])(_component_demo_block, null, {
...
// CONCATENATED MODULE: ./website/docs/zh-CN/message-box.md?vue&type=template&id=22299347
...
message_boxvue_type_script_lang_ts.render = message_boxvue_type_template_id_22299347_render
