import{o as e,c as n,e as s}from"./app.fd11312f.js";const a=s(`<h1 id="development-faq" tabindex="-1">Development FAQ <a class="header-anchor" href="#development-faq" aria-hidden="true">#</a></h1><p>Here are the problems that are easy to encounter in development.</p><h2 id="if-you-encounter-dependency-related-issues" tabindex="-1">If you encounter dependency related issues <a class="header-anchor" href="#if-you-encounter-dependency-related-issues" aria-hidden="true">#</a></h2><div class="language-bash"><pre><code><span class="token function">rm</span> -fr node_modules
