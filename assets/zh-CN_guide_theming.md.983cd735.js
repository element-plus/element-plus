...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre></div><h3 id="\u5982\u4F55\u8986\u76D6\u5B83\uFF1F" tabindex="-1">\u5982\u4F55\u8986\u76D6\u5B83\uFF1F <a class="header-anchor" href="#\u5982\u4F55\u8986\u76D6\u5B83\uFF1F" aria-hidden="true">#</a></h3><p>\u5982\u679C\u60A8\u7684\u9879\u76EE\u4E5F\u4F7F\u7528\u4E86 SCSS\uFF0C\u53EF\u4EE5\u76F4\u63A5\u4FEE\u6539 Element Plus \u7684\u6837\u5F0F\u53D8\u91CF\u3002 \u65B0\u5EFA\u4E00\u4E2A\u6837\u5F0F\u6587\u4EF6\uFF0C\u4F8B\u5982 <code>styles/element/index.scss</code>\uFF1A</p><div class="warning custom-block"><p class="custom-block-title">WARNING</p><p>\u60A8\u5E94\u8BE5\u4F7F\u7528 <code>@use &#39;xxx.scss&#39; as *;</code> \u4EE3\u66FF <code>@import &#39;xxx.scss&#39;;</code>\u3002</p><p>\u56E0\u4E3A sass \u56E2\u961F\u8BF4\u4ED6\u4EEC\u6700\u7EC8\u4F1A\u5220\u9664 <code>@import</code> \u8BED\u6CD5\u3002</p><blockquote><p><a href="https://sass-lang.com/documentation/at-rules/use" target="_blank" rel="noopener noreferrer">Sass: @use</a> vs <a href="https://sass-lang.com/documentation/at-rules/import" target="_blank" rel="noopener noreferrer">Sass: @import</a></p></blockquote></div><div class="language-scss"><pre><code><span class="token comment">// styles/element/index.scss</span>
...
</code></pre></div><p>\u7136\u540E\u5728\u4F60\u7684\u9879\u76EE\u5165\u53E3\u6587\u4EF6\u4E2D\uFF0C\u5BFC\u5165\u8FD9\u4E2A\u6837\u5F0F\u6587\u4EF6\u4EE5\u66FF\u6362 Element Plus \u5185\u7F6E\u7684 CSS\uFF1A</p><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>\u5728 element-plus scss \u6587\u4EF6\u4E4B\u524D\u5BFC\u5165<code>element/index.scss</code>\u4EE5\u907F\u514D sass \u6DF7\u5408\u53D8\u91CF\u7684\u95EE\u9898\uFF0C\u56E0\u4E3A\u6211\u4EEC\u9700\u8981\u901A\u8FC7\u4F60\u7684\u81EA\u5B9A\u4E49\u53D8\u91CF\u751F\u6210 light-x\u3002</p></div><p>\u521B\u5EFA\u4E00\u4E2A <code>element/index.scss</code> \u6587\u4EF6\u6765\u5408\u5E76\u4F60\u7684\u53D8\u91CF\u548C element-plus \u7684\u53D8\u91CF\u3002 \uFF08\u5982\u679C\u4F60\u5728 TypeScript \u4E2D\u5BFC\u5165\u4E86\u5B83\u4EEC\uFF0C\u4ED6\u4EEC\u5C06\u4E0D\u4F1A\u88AB\u5408\u5E76\uFF09</p><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>\u9664\u6B64\u4EE5\u5916\uFF0C\u4F60\u5E94\u8BE5\u5C06\u4F60\u7684 scss \u6587\u4EF6\u4E0E element \u53D8\u91CF\u7684 scss \u6587\u4EF6\u533A\u5206\u5F00\u6765\u3002 \u5982\u679C\u5C06\u5B83\u4EEC\u6DF7\u5408\u5728\u4E00\u8D77\uFF0C<code>element-plus</code> \u6BCF\u6B21\u70ED\u66F4\u65B0\u90FD\u9700\u8981\u7F16\u8BD1\u5927\u91CF\u7684 scss \u6587\u4EF6\uFF0C\u8FD9\u5C06\u4F1A\u5BFC\u81F4\u7F16\u8BD1\u901F\u5EA6\u53D8\u6162\u3002</p></div><div class="language-ts"><pre><code><span class="token keyword">import</span> <span class="token punctuation">{</span> createApp <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;vue&#39;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token function">defineConfig</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre></div><h3 id="\u901A\u8FC7-css-\u53D8\u91CF\u8BBE\u7F6E" tabindex="-1">\u901A\u8FC7 CSS \u53D8\u91CF\u8BBE\u7F6E <a class="header-anchor" href="#\u901A\u8FC7-css-\u53D8\u91CF\u8BBE\u7F6E" aria-hidden="true">#</a></h3><p>CSS \u53D8\u91CF\u662F\u4E00\u4E2A\u975E\u5E38\u6709\u7528\u7684\u529F\u80FD\uFF0C\u51E0\u4E4E\u6240\u6709\u6D4F\u89C8\u5668\u90FD\u652F\u6301\u3002 \uFF08IE\uFF1A\u554A\u8FD9\uFF1F)</p><blockquote><p>\u4ECE <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/Using_CSS_custom_properties" target="_blank" rel="noopener noreferrer">\u4F7F\u7528CSS\u81EA\u5B9A\u4E49\u5C5E\u6027(\u53D8\u91CF) | MDN</a> \u4E86\u89E3\u66F4\u591A\u4FE1\u606F</p></blockquote><p>We have used css variables to reconstruct the style system of almost all components.</p><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>\u5B83\u517C\u5BB9 SCSS \u53D8\u91CF\u7CFB\u7EDF\u3002 \u6211\u4EEC\u4F7F\u7528 SCSS \u7684\u51FD\u6570\u81EA\u52A8\u751F\u6210\u9700\u8981\u7528\u5230\u7684 css \u53D8\u91CF\u3002</p></div><p>\u8FD9\u610F\u5473\u7740\u4F60\u53EF\u4EE5\u52A8\u6001\u5730\u6539\u53D8\u7EC4\u4EF6\u5185\u7684\u4E2A\u522B\u53D8\u91CF\uFF0C\u4EE5\u4FBF\u66F4\u597D\u5730\u81EA\u5B9A\u4E49\u7EC4\u4EF6\u6837\u5F0F\uFF0C\u800C\u4E0D\u9700\u8981\u4FEE\u6539 SCSS \u6587\u4EF6\u91CD\u65B0\u7F16\u8BD1\u4E00\u6B21\u3002</p><blockquote><p>\u4E4B\u540E\uFF0C\u6BCF\u4E2A\u7EC4\u4EF6\u7684 css \u53D8\u91CF\u540D\u79F0\u548C\u4F5C\u7528\u5C06\u88AB\u5199\u5165\u5230\u5BF9\u5E94\u7684\u7EC4\u4EF6\u6587\u6863\u4E2D\u3002</p></blockquote><p>\u5C31\u50CF\u8FD9\u6837\uFF1A</p><div class="language-css"><pre><code><span class="token selector">:root</span> <span class="token punctuation">{</span>
...
</code></pre></div><p>\u51FA\u4E8E\u6027\u80FD\u539F\u56E0\uFF0C\u66F4\u52A0\u63A8\u8350\u4F60\u5728\u7C7B\u540D\u4E0B\u6DFB\u52A0\u81EA\u5B9A\u4E49 css \u53D8\u91CF\uFF0C\u800C\u4E0D\u662F\u5728\u5168\u5C40\u7684 <code>:root</code> \u4E0B\u3002</p><div class="language-css"><pre><code><span class="token selector">.custom-class</span> <span class="token punctuation">{</span>
  <span class="token property">--el-tag-bg-color</span><span class="token punctuation">:</span> red<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre></div><p>\u5982\u679C\u60A8\u60F3\u8981\u901A\u8FC7 js \u63A7\u5236 css \u53D8\u91CF\uFF0C\u53EF\u4EE5\u8FD9\u6837\u505A\uFF1A</p><div class="language-ts"><pre><code><span class="token comment">// document.documentElement \u662F\u5168\u5C40\u53D8\u91CF\u65F6</span>
...
</code></pre></div><p>\u5982\u679C\u4F60\u60F3\u8981\u66F4\u4F18\u96C5\u7684\u65B9\u5F0F\uFF0C\u8BF7\u770B\u8FD9\u91CC\u3002 <a href="https://vueuse.org/core/usecssvar/" target="_blank" rel="noopener noreferrer">useCssVar | VueUse</a></p>`,40),o=[e];function c(l,u,i,r,k,m){return a(),s("div",null,o)}var h=n(p,[["render",c]]);export{g as __pageData,h as default};
