...
| show-after ^(2.9.10) | delay of appearance, in millisecond      | ^[number]                                            | 0       |
| hide-after ^(2.9.10) | delay of disappear, in millisecond       | ^[number]                                            | 200     |
| auto-close ^(2.9.10) | timeout in milliseconds to hide alert    | ^[number]                                            | 0       |

### Events

| Name           | Description                   | Type                                 |
| -------------- | ----------------------------- | ------------------------------------ |
| open ^(2.9.10) | trigger when alert is opened. | ^[Function]`() => void`              |
