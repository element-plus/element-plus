...
Sometimes you may want your button to immediately restore its original style after being clicked.

We provide a property `clickAutoBlur` to make it lose focus and restore its original style.

:::demo

button/click-auto-blur
...
| click-auto-blur   | automatically blur after el-button was clicked to restore its original style | ^[boolean]                                                   | false   |
