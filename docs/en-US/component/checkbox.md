...
| true-value ^(2.6.0)            | value of the Checkbox if it's checked                                                                                                                          | ^[string] / ^[number] / ^[boolean]             | —       |
| false-value ^(2.6.0)           | value of the Checkbox if it's not checked                                                                                                                      | ^[string] / ^[number] / ^[boolean]             | —       |
