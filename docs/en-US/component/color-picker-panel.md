...
| hue-slider-class ^(2.13.3) | class names will be passed to hue-slider   | ^[object]`string \| string[] \| Record<string, boolean>`                                              | —                                                                            |
| hue-slider-style ^(2.13.3) | styles will be passed to hue-slider        | ^[string] / ^[object]`StyleValue`                                                                     | —                                                                            |
