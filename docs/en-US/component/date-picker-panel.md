...
| type                   | type of the picker. `quarter`, `quarters`, and `quarterrange` are supported since ^(2.14.3)                                                | ^[enum]`'year' \| 'years' \|'month' \| 'months' \| 'date' \| 'dates' \| 'datetime' \| 'week' \| 'quarter' \| 'quarters' \| 'datetimerange' \| 'daterange' \| 'monthrange' \| 'yearrange' \| 'quarterrange'` | date       |
