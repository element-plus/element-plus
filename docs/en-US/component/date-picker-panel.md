...
| type                   | type of the picker. `weeks` is supported since ^(2.14.6). `quarter`, `quarters`, and `quarterrange` are supported since ^(2.14.5)                     | ^[enum]`'year' \| 'years' \|'month' \| 'months' \| 'date' \| 'dates' \| 'datetime' \| 'week' \| 'weeks' \| 'quarter' \| 'quarters' \| 'datetimerange' \| 'daterange' \| 'monthrange' \| 'yearrange' \| 'quarterrange'` | date       |
...
| show-footer            | whether to show footer where the date picker is one ^[enum]`'dates' \| 'months' \| 'years' \| 'quarters' \| 'weeks' \| 'datetime' \| 'datetimerange'` | ^[boolean]                                                                                                                                                                                                             | false      |
