...
| ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| model-value / v-model        | binding value.<br>For range types (`daterange`, `monthrange`, `yearrange`) the array length should be 2.<br>For multiple selection types (`dates`, `months`, `years`) it accepts an array of values. | ^[Date] / ^[number] / ^[string] / ^[array]`Date[] \| number[] \| string[]`                                                                                     | ''            |
