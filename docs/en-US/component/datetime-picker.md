...
| ----------------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ | ------------------------------------------------------------- | ------------------- |
| model-value / v-model   | binding value, if it is an array, the length should be 2                                                       | ^[enum]`'Date'\|'number'\|'string'\|'Array'`                   | —                                                             | —                   |
| readonly                | whether DatePicker is read only                                                                                | ^[boolean]                                          | —                                                             | false               |
| disabled                | whether DatePicker is disabled                                                                                 | ^[boolean]                                          | —                                                             | false               |
| editable                | whether the input is editable                                                                                  | ^[boolean]                                          | —                                                             | true                |
| clearable               | whether to show clear button                                                                                   | ^[boolean]                                          | —                                                             | true                |
| size                    | size of Input                                                                                                  | ^[string]                                           | ^[enum]`'large'\|'default'\|'small'`                                           | default             |
| placeholder             | placeholder in non-range mode                                                                                  | ^[string]                                           | —                                                             | —                   |
| start-placeholder       | placeholder for the start date in range mode                                                                   | ^[string]                                           | —                                                             | —                   |
| end-placeholder         | placeholder for the end date in range mode                                                                     | ^[string]                                           | —                                                             | —                   |
| arrow-control           | whether to pick time using arrow buttons                                                                       | ^[boolean]                                          | —                                                             | false               |
| type                    | type of the picker                                                                                             | ^[string]                                           | ^[enum]`'year'\|'month'\|'date'\|'datetime'\|'week'\|'datetimerange'\|'daterange'`        | date                |
