...
| header-class ^(2.9.2)      | custom class names for header slot                                                                   | ^[string]                           | —       |
| body-class ^(2.9.2)        | custom class names for default slot                                                                  | ^[string]                           | —       |
| footer-class ^(2.9.2)      | custom class names for footer slot                                                                   | ^[string]                           | —       |
