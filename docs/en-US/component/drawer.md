...
| min-size ^(2.13.1)         | minimum size of drawer, accepts number (px) or string with % notation. If not set, defaults to the value of `size` prop. If `size` is also not set, defaults to 200px                                                                                                                                        | ^[number] / ^[string]                                                                                                                                                                          | —       |
| max-size ^(2.13.1)         | maximum size of drawer, accepts number (px) or string with % notation. If not set, defaults to the full viewport size                                                                                                                                                                                        | ^[number] / ^[string]                                                                                                                                                                          | —       |
