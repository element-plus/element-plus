...
| triggerKeys ^(2.9.1) | specify whick keys on the keyboard can trigger when pressed                                                           | ^[array]`'Enter' \| 'Space' \| 'ArrowDown' \| 'NumpadEnter' []`                                                               | `['Enter', 'Space', 'ArrowDown', 'NumpadEnter']`
