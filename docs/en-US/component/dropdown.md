...
| menu-trigger ^(2.15.0)       | how to trigger the sub menu                                                                                           | ^[enum]`'hover' \| 'click'`                                                                                  | hover                                                                      |
...
| menu-popper-offset ^(2.15.0) | offset of the sub menu popper                                                                                         | ^[number]                                                                                                    | -6                                                                         |
| menu-placement ^(2.15.0)     | placement of pop sub menu                                                                                             | ^[enum]`Placement`                                                                                           | right-start                                                                |
...
| placement           | placement of pop sub menu                                                                                                               | ^[enum]`Placement`              | right-start                                                                                                                    |
...
| append-to           | which element the dropdown CONTENT appends to                                                                                           | ^[CSSSelector] / ^[HTMLElement] | —                                                                                                                              |
| fallback-placements | list of possible positions for DropdownSubMenu's dropdown [popper.js](https://popper.js.org/docs/v2/modifiers/flip/#fallbackplacements) | ^[array]`Placement[]`           | ['right-start', 'right', 'right-end', 'left-start', 'left', 'left-end', 'bottom-start', 'bottom-end', 'top-start', 'top-end' ] |
...
| pointerenter ^(2.15.0) | triggers when pointer enters the item | ^[Function]`(evt: PointerEvent) => void` |
...
| pointerdown ^(2.15.0)  | triggers when pointer clicks the item | ^[Function]`(evt: PointerEvent) => void` |
