...
| menu-popper-offset ^(2.12.0) | offset of the sub menu popper                                                                                         | ^[number]                                                                                                                                              | -6                                                                         |
| menu-placement ^(2.12.0)     | placement of pop sub menu                                                                                             | ^[enum]`'right-start' \| 'right' \| 'right-end' \| 'left-start' \| 'left' \| 'left-end' \| 'bottom-start' \| 'bottom-end' \| 'top-start' \| 'top-end'` | right-start                                                                |
...
| placement     | placement of pop sub menu                            | ^[enum]`'right-start' \| 'right' \| 'right-end' \| 'left-start' \| 'left' \| 'left-end' \| 'bottom-start' \| 'bottom-end' \| 'top-start' \| 'top-end'` | right-start |
