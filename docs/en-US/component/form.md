...
| getFieldsValue | According to the specified field, return field value of corresponding structure.                     | ^[Function]`(props?: Arrayable<FormItemProp> \| undefined) => Record<string, any>`                                                               |
