...
| sub-menu-show-timeout ^(2.4.5)  | Control timeout for all sub menus before showing                                                                                                                      | `number`              | —                     | 300      |
| sub-menu-hide-timeout ^(2.4.5)  | Control timeout for all sub menus before hiding                                                                                                                       | `number`              | —                     | 300      |
...
| show-timeout                      | timeout before showing a sub-menu                                                                                                             | number                | —               | —                                               |
| hide-timeout                      | timeout before hiding a sub-menu                                                                                                              | number                | —               | —                                               |
