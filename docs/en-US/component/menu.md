...
| sub-menu-arrow-down-icon  | replace all title icons pointing down of all submenus with custom icon                                                                                                | string/Component | —                     | ArrowDown  |
| sub-menu-arrow-right-icon | replace all title icons pointing right of all submenus with custom icon                                                                                               | string/Component | —                     | ArrowRight |
