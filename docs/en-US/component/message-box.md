...
| message                           | content of the MessageBox                                                                                                                | ^[string] / ^[VNode] / ^[Function]`() => VNode` ^(2.2.17) / ^[Function]`({ confirm, cancel, close }) => VNode` ^(2.14.0) | —                                                |
...
| locale ^(2.14.1)                  | set the locale object for the MessageBox                                                                                                 | ^[object]`Language`                                                                                                      | —                                                |
