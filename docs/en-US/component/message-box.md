...
| cancel-button-loading-icon ^(2.7.7)  | loading icon content of cancel button                                                                                                    | ^[string] / ^[Component]                                                           | Loading                                          |
| confirm-button-loading-icon ^(2.7.7) | loading icon content of confirm button                                                                                                   | ^[string] / ^[Component]                                                           | Loading                                          |
