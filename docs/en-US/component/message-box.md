...
| closeIcon ^(2.8.3)                | custom close icon component, default is Close                                                                                            | ^[string] / ^[Component]                                                           | ''                                               |
...
| inputValue                        | initial value of input                                                                                                                   | ^[string]                                                                          | null                                             |
| inputPattern                      | regexp for the input                                                                                                                     | ^[regexp]                                                                          | null                                             |
| inputValidator                    | validation function for the input. Should returns a boolean or string. If a string is returned, it will be assigned to inputErrorMessage | ^[Function]`(value: string) => boolean \| string`                                  | null                                             |
...
| appendTo ^(2.2.19)                | set the root element for the message box                                                                                                 | ^[string] / ^[HTMLElement]                                                         | —                                                |
