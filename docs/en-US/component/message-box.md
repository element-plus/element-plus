...
| cancel-button-loading-icon   | loading icon content of cancel button                                                                                                    | ^[string] / ^[Component]                                                           | Loading                                          |
| confirm-button-loading-icon  | loading icon content of confirm button                                                                                                   | ^[string] / ^[Component]                                                           | Loading                                          |
