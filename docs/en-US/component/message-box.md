...
| cancelButtonType ^(2.13.1)        | type of cancel button                                                                                                                    | ^[enum]`'primary' \| 'success' \| 'warning' \| 'danger' \| 'info' \| 'text'`                        | text                                             |
| confirmButtonType ^(2.13.1)       | type of confirm button                                                                                                                   | ^[enum]`'primary' \| 'success' \| 'warning' \| 'danger' \| 'info' \| 'text'`                        | primary                                          |
