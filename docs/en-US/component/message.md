...
Control the position where messages appear. Messages can be displayed at the top (default) or bottom of the viewport.
...
| placement ^(2.11.0)      | message placement position                                                                             | ^[enum]`'top' \| 'bottom'`                                                 | top     |
