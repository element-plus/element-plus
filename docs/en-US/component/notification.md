...
| position                 | custom position. `top` and `bottom` are supported since ^(2.14.6)                                                                                                                                                                                  | ^[enum]`'top' \| 'top-right' \| 'top-left' \| 'bottom' \| 'bottom-right' \| 'bottom-left'` | top-right |
...
| offset                   | offset from the edge of the screen. Top positions use the top edge and bottom positions use the bottom edge. Every Notification instance of the same position should have the same offset                                                          | ^[number]                                                                                  | 0         |
