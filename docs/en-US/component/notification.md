...
:::demo The `position` attribute defines where the Notification slides in. It can be `top`, `bottom`, `top-right`, `top-left`, `bottom-right`, or `bottom-left`. Defaults to `top-right`.
...
| position                 | custom position                                                                                                                                                                                                                                    | ^[enum]`'top' (2.14.5) \| 'top-right' \| 'top-left' \| 'bottom' (2.14.5) \| 'bottom-right' \| 'bottom-left'` | top-right |
