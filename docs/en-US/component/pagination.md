...
| prev-icon                           | icon for the prev button, lower priority of `prev-text`                                                                         | ^[string] / ^[Component]                                                          | ArrowLeft                            |
| next-text                           | text for the next button                                                                                                        | ^[string]                                                                         | ''                                   |
| next-icon                           | icon for the next button, lower priority of `next-text`                                                                         | ^[string] / ^[Component]                                                          | ArrowRight                           |
