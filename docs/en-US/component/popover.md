...
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------- | --------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| trigger                   | how the popover is triggered                                                                                                                                             | `string`          | ^[enum]`'click' \| 'focus' \| 'hover' \| 'contextmenu'`                                                                             | hover                                                                      |
| title                     | popover title                                                                                                                                                            | `string`          | —                                                                                                         | —                                                                          |
| effect                    | Tooltip theme, built-in theme: `dark` / `light`                                                                                                                          | `string`          | `string`                                                                                                    | light                                                                      |
| content                   | popover content, can be replaced with a default `slot`                                                                                                                   | `string`          | —                                                                                                         | —                                                                          |
| width                     | popover width                                                                                                                                                            | `string` / `number` | —                                                                                                         | Min width 150px                                                            |
| placement                 | popover placement                                                                                                                                                        | `string`          | ^[enum]`'top' \| 'top-start' \| 'top-end' \| 'bottom' \| 'bottom-start' \| 'bottom-end' \| 'left' \| 'left-start' \| 'left-end' \| 'right' \| 'right-start' \| 'right-end' \| 'bottom'`                                                                     |
