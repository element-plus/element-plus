...
| vertical-start-gap ^(2.14.3)      | distance(px) between vertical scrollbar track and the top edge of viewport                                                      | ^[number]                                                           | 0       |
| vertical-end-gap ^(2.14.3)        | distance(px) between vertical scrollbar track and the bottom edge of viewport                                                   | ^[number]                                                           | 0       |
