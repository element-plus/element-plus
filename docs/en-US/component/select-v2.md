...
| clear-icon                          | custom clear icon component, default value comes from [Config Provider icons](/en-US/component/config-provider#icons-attribute) `clear` property     | ^[string] / ^[object]`Component`                                                                                                                                            | CircleClose                                    |
...
| suffix-icon ^(2.9.8)                | custom suffix icon component, default value comes from [Config Provider icons](/en-US/component/config-provider#icons-attribute) `dropdown` property | ^[string] / ^[object]`Component`                                                                                                                                            | ArrowDown                                      |
