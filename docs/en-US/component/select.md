...
| tag ^(2.5.0)     | content as Select tag, subTags `data` and `deleteTag` introduced in ^(2.10.3) | ^[object]`{ data: OptionBasic[], deleteTag: (event: MouseEvent, tag: OptionPublicInstance \| OptionBasic) => void }` |
