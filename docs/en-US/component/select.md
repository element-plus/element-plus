...
| append-to                           | which element the selection dropdown appends to                                                                             | string                                     | —                                                                                                         | body             |
| teleported                          | whether select dropdown is teleported to the body (or `append-to` if it's defined)                                          | boolean                                    | true / false                                                                                              | true             |
