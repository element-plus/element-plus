...
| collapse-tags-tooltip-append-to | which element the collapse-tags tooltip appends to. To use this, `collapse-tags` and `collapse-tags-tooltip` must be true                | ^[CSSSelector] / ^[HTMLElement]                                                                                                                                             | —                                              |
