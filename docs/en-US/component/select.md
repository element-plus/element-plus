...
| suffix-icon                     | custom suffix icon component, default value comes from [Config Provider icons](/en-US/component/config-provider#icons-attribute) `dropdown` property | ^[string] / ^[object]`Component`                                                                                                                                            | ArrowDown                                      |
