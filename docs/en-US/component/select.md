...
| popper-class                          | custom class name for Select's wrapper                                                                                                   | ^[string]                                                                                                                                                                   | ''                                             |
| popper-style ^(2.11.0)                | custom style for Select's wrapper                                                                                                        | ^[string] / ^[object]                                                                                                                                                       | —                                              |
| wrapper-class ^(2.14.3)               | custom class name for Select's dropdown and tags' tooltip                                                                                | ^[string]                                                                                                                                                                   | ''                                             |
| wrapper-style ^(2.14.3)               | custom style for Select's dropdown and tags' tooltip                                                                                     | ^[string] / ^[object]                                                                                                                                                       | —                                              |
