...
| tooltip-append-to ^(2.13.3)     | which element the tooltip CONTENT appends to. To use this, `collapse-tags` and `collapse-tags-tooltip` must be true                      | ^[CSSSelector] / ^[HTMLElement]                                                                                                                                             | —                                              |
