...
| empty-values ^(2.7.0)           | empty values supported by the component                                                                               | ^[array]                                                                                                                                                                    | —                                              |
| value-on-clear ^(2.7.0)         | return value when cleared, if you want to set `undefined`, use `() => undefined`                                      | ^[string] / ^[number] / ^[boolean] / ^[Function]                                                                                                                            | —                                              |
