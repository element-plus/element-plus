...
| persistent ^(2.9.5)         | When slider tooltip inactive and `persistent` is `false`, tooltip will be destroyed. `persistent` is always `false` when `show-tooltip` is `false` | ^[boolean]                                                                                                                                                                  | true    |
