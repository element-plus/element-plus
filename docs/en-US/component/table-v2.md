...
| maxWidth           | Maximum width for the column                                          | Number / String                                                                                                                                                  | -       |
| minWidth           | Minimum width for the column                                          | Number / String                                                                                                                                                  | -       |
| width ^(required)  | Width for the column                                                  | Number / String                                                                                                                                                  | -       |
