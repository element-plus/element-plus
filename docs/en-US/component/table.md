...
| expand-row-keys                    | set expanded rows by this prop, prop's value is the keys of expand rows, you should set row-key before using this prop. starting from version ^(2.9.8), keys of type number are supported.                                                                                 | ^[object]`Array<string \| number>`                                                                                                                                   | —                                                                                                                       |
