...
| tooltip-options<VersionTag version="2.2.27" /> | the options for the overflow tooltip, [see the following tooltip component](tooltip.html#attributes)                                                                                                                                                                        | [`object`](tooltip.html#attributes)                         | [](https://github.com/element-plus/element-plus/blob/master/packages/components/table/src/util.ts#L21-L29) | ^[object]`{ enterable: true, placement: 'top', showArrow: true, hideAfter: 200, popperOptions: { strategy: 'fixed' } }`  |
...
| show-overflow-tooltip | whether to hide extra content and show them in a tooltip when hovering on the cell                                                                                                                                  | boolean \| [`object`](#table-attributes)<VersionTag version="2.2.27" /> | Refer to table [tooltip-options](#table-attributes)                                                                              | —                                 |
