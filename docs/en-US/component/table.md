...
| row-click          | triggers when clicking a row                                                                                                                 | ^[Function]`(row: any, column: TableColumnCtx<T> \| null, event: Event) => void`                        |
| row-contextmenu    | triggers when user right clicks on a row                                                                                                     | ^[Function]`(row: any, column: TableColumnCtx<T> \| null, event: Event) => void`                        |
| row-dblclick       | triggers when double clicking a row                                                                                                          | ^[Function]`(row: any, column: TableColumnCtx<T> \| null, event: Event) => void`                        |
...
| sort-change        | triggers when Table's sorting changes                                                                                                        | ^[Function]`(data: {column: TableColumnCtx<T>, prop: string, order: TableSortOrder \| null }) => void`  |
