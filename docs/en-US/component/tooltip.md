...
| <el-space>virtual-triggering <el-tag size="small">v.1.3.0</el-tag></el-space> | Indicates whether virtual triggering is enabled                                                                                                              | boolean     | -                                                                                                         | false                                                   |
| <el-space>virtual-ref <el-tag size="small">v1.3.0</el-tag></el-space>         | Indicates the reference element to which the tooltip is attached                                                                                             | HTMLElement | -                                                                                                         | -                                                       |
