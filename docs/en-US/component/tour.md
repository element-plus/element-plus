...
| close-icon                | custom close icon component, default value comes from [Config Provider icons](/en-US/component/config-provider#icons-attribute) `close` property | ^[string] / ^[Component]                                                                                                                                                    | Close                              |
