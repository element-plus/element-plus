...
| close-on-click-modal ^(2.10.5) | whether the Tour can be closed by clicking the mask                              | `boolean`                                                                                                                                                                   | `true`                             |
| close-on-press-escape          | whether the Tour can be closed by pressing ESC                                   | `boolean`                                                                                                                                                                   | `true`                             |
