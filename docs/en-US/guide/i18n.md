...
If you think the translation is inaccurate or need to use other languages, [PR](https://github.com/element-plus/element-plus/pulls) is always welcomed.
The language files are stored [here](https://github.com/element-plus/element-plus/tree/dev/packages/locale/lang).
<br />
Additionally, you can also create a local language file for import and use.
