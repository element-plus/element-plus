...
<script lang='ts'>
import { defineComponent, ref, computed, getCurrentInstance, nextTick, watch, onMounted } from 'vue'
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const store = computed(() => _checkboxGroup ? _checkboxGroup.modelValue : props.modelValue)
    ...
    function handleChange(e: UIEvent) {
      ...
      nextTick(() => {
        if (isGroup.value) {
          _checkboxGroup.changeEvent?.(_checkboxGroup.modelValue)
        }
      })
    }
