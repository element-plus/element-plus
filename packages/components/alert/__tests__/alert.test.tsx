...
describe('Alert.vue', () => {
  test('render test & class', () => {
    ...
    expect(wrapper.find('.g-alert__title').text()).toEqual(AXIOM)
    expect(wrapper.find('.g-alert').classes()).toContain('g-alert--info')
  })
  ...
  test('type', () => {
    ...
    expect(wrapper.find('.g-alert').classes()).toContain('g-alert--success')
    expect(wrapper.find('.g-alert__icon').classes()).toContain('g-icon')
  ...
  test('description', () => {
    ...
    expect(wrapper.find('.g-alert__description').text()).toEqual(AXIOM)
  })

  test('theme', () => {
    const wrapper = mount(() => <Alert title={'test'} effect={'dark'} />)
    expect(wrapper.find('.g-alert').classes()).toContain('is-dark')
  })
  ...
  test('close', async () => {
    ...
    const closeBtn = wrapper.find('.g-alert__close-btn')
  ...
  describe('default slot', () => {
    test.each([
      ...
      const description = wrapper.find('.g-alert__description')
