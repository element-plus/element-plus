...
import { PICKER_BASE } from '@element-plus/components/time-picker'
import {
...
import { ROOT_PICKER_IS_DEFAULT_FORMAT } from '../constants'
...
const isDefaultFormat = inject(ROOT_PICKER_IS_DEFAULT_FORMAT) as any
