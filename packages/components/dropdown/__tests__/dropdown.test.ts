...
describe('Dropdown', () => {
  ...
  test('create', async () => {
    const wrapper = _mount(
      `
        <g-dropdown ref="b" placement="right">
          <span class="g-dropdown-link" ref="a">
            dropdown<i class="g-icon-arrow-down el-icon--right"></i>
          </span>
          <template #dropdown>
            <g-dropdown-menu>
              <g-dropdown-item>Apple</g-dropdown-item>
              <g-dropdown-item>Orange</g-dropdown-item>
              <g-dropdown-item>Cherry</g-dropdown-item>
              <g-dropdown-item disabled>Peach</g-dropdown-item>
              <g-dropdown-item divided>Pear</g-dropdown-item>
            </g-dropdown-menu>
          </template>
        </g-dropdown>
      `,
    ...
    await nextTick()
    const content = wrapper.findComponent(GTooltip).vm as InstanceType<
      typeof GTooltip
    >

    vi.useFakeTimers()
    const triggerElm = wrapper.find('.g-tooltip__trigger')
  ...
  test('menu click', async () => {
    ...
    const wrapper = _mount(
      `
      <g-dropdown ref="b" @command="commandHandler" placement="right">
        <span class="g-dropdown-link" ref="a">
          dropdown<i class="g-icon-arrow-down el-icon--right"></i>
        </span>
        <template #dropdown>
          <g-dropdown-menu>
            <g-dropdown-item command="a">Apple</g-dropdown-item>
            <g-dropdown-item command="b">Orange</g-dropdown-item>
            <g-dropdown-item ref="c" :command="myCommandObject">Cherry</g-dropdown-item>
            <g-dropdown-item command="d">Peach</g-dropdown-item>
            <g-dropdown-item command="e">Pear</g-dropdown-item>
          </g-dropdown-menu>
        </template>
      </g-dropdown>
      `,
  ...
  test('trigger', async () => {
    const wrapper = _mount(
      `
      <g-dropdown trigger="click" ref="b" placement="right">
        <span class="g-dropdown-link" ref="a">
          dropdown<i class="g-icon-arrow-down el-icon--right"></i>
        </span>
        <template #dropdown>
    ...
    const content = wrapper.findComponent(GTooltip).vm as InstanceType<
      typeof GTooltip
    >
    const triggerElm = wrapper.find('.g-dropdown-link')
    expect(content.open).toBe(false)
    await triggerElm.trigger(MOUSE_ENTER_EVENT)
    expect(content.open).toBe(false)
  ...
  test('trigger contextmenu', async () => {
    const wrapper = _mount(
      `
      <g-dropdown trigger="contextmenu" ref="b" placement="right">
        <span class="g-dropdown-link" ref="a">
          dropdown<i class="g-icon-arrow-down el-icon--right"></i>
        </span>
        <template #dropdown>
  ...
  test('virtual ref', async () => {
    const wrapper = _mount(
      `
      <g-button style="height: 400px; width: 400px" @click="handleClick" @contextmenu="handleContextmenu">
        Right click
      </g-button>
      <g-dropdown
        ref="dropdownRef"
    ...
    const content = wrapper.findComponent(GTooltip).vm as InstanceType<
      typeof GTooltip
    >
    const triggerElm = wrapper.find('.g-button')
  ...
  test('handleOpen and handleClose', async () => {
    const wrapper = _mount(
      `
      <g-dropdown trigger="click" ref="refDropdown" placement="right">
        <span class="g-dropdown-link" ref="a">
          dropdown<i class="g-icon-arrow-down el-icon--right"></i>
        </span>
        <template #dropdown>
          <g-dropdown-menu>
            <g-dropdown-item command="a">Apple</g-dropdown-item>
            <g-dropdown-item command="b">Orange</g-dropdown-item>
            <g-dropdown-item command="c">Cherry</g-dropdown-item>
            <g-dropdown-item command="d">Peach</g-dropdown-item>
            <g-dropdown-item command="e">Pear</g-dropdown-item>
          </g-dropdown-menu>
        </template>
  ...
  test('split button', async () => {
    ...
    const wrapper = _mount(
      `
      <g-dropdown  @click="handleClick" split-button type="primary" ref="b" placement="right">
        dropdown
        <template #dropdown>
          <g-dropdown-menu>
            <g-dropdown-item command="a">Apple</g-dropdown-item>
    ...
    const content = wrapper.findComponent(GTooltip).vm as InstanceType<
      typeof GTooltip
    >
    const triggerElm = wrapper.find('.g-dropdown__caret-button')
    const button = wrapper.find('.g-button')
    expect(content.open).toBe(false)
  ...
  test('hide on click', async () => {
    const wrapper = _mount(
      `
      <g-dropdown ref="b" placement="right" :hide-on-click="false">
        <span class="g-dropdown-link" ref="a">
          dropdown<i class="g-icon-arrow-down el-icon--right"></i>
        </span>
        <template #dropdown>
          <g-dropdown-menu>
            <g-dropdown-item>Apple</g-dropdown-item>
            <g-dropdown-item>Orange</g-dropdown-item>
            <g-dropdown-item ref="c">Cherry</g-dropdown-item>
            <g-dropdown-item disabled>Peach</g-dropdown-item>
            <g-dropdown-item divided>Pear</g-dropdown-item>
          </g-dropdown-menu>
        </template>
  ...
  test('max height', async () => {
    const wrapper = _mount(
      `
      <g-dropdown ref="b" max-height="60px">
        <span class="g-dropdown-link" ref="a">
          dropdown<i class="g-icon-arrow-down el-icon--right"></i>
        </span>
        <template #dropdown>
    ...
    expect(scrollbar.find('.g-scrollbar__wrap').attributes('style')).toContain(
      'max-height: 60px;'
    )
  })
      ...
      <g-dropdown ref="b">
        ...
        <template #dropdown>
          <g-dropdown-menu>
            ...
            <g-dropdown-item>Orange</g-dropdown-item>
            <g-dropdown-item>Cherry</g-dropdown-item>
            <g-dropdown-item>Peach</g-dropdown-item>
            <g-dropdown-item>Pear</g-dropdown-item>
          </g-dropdown-menu>
        </template>
      </g-dropdown>
      `,
  ...
  test('popperClass', async () => {
    const wrapper = await _mount(
      `
      <g-dropdown ref="b" max-height="60px" popper-class="custom-popper-class">
        <span class="g-dropdown-link" ref="a">
          dropdown<i class="g-icon-arrow-down el-icon--right"></i>
        </span>
        <template #dropdown>
  ...
  test('custom attributes for dropdown items', async () => {
    const wrapper = _mount(
      ...
      <g-dropdown>
        ...
        <template #dropdown>
          <g-dropdown-menu>
            <g-dropdown-item data-custom-attribute="hello">Item</g-dropdown-item>
          </g-dropdown-menu>
        </template>
      </g-dropdown>
      `,
    ...
    expect(
      wrapper
        ...
        .find('.g-dropdown-menu__item').element.dataset.customAttribute
    ).toBe('hello')
  })
  ...
  test('disable dropdown with split button', async () => {
    const wrapper = _mount(
      `
      <g-dropdown disabled split-button>
        <span class="g-dropdown-link">
          Dropdown List
        </span>
        <template #dropdown>
  ...
  test('set show-timeout/hide-timeout when trigger is hover', async () => {
    const wrapper = _mount(
      `
      <g-dropdown trigger="hover" :show-timeout="200" :hide-timeout="300">
        <span class="g-dropdown-link">
          Dropdown List
        </span>
        <template #dropdown>
          <g-dropdown-menu>
            <g-dropdown-item>Item</g-dropdown-item>
          </g-dropdown-menu>
        </template>
      </g-dropdown>
      `,
  ...
  test('ignore show-timeout/hide-timeout when trigger is not hover', async () => {
    const wrapper = _mount(
      `
      <g-dropdown trigger="click" :show-timeout="200" :hide-timeout="300">
        <span class="g-dropdown-link">
          Dropdown List
        </span>
        <template #dropdown>
  ...
  describe('accessibility', () => {
    test('Custom span trigger has proper attributes', async () => {
      const wrapper = _mount(
        `
        <g-dropdown>
          <span class="g-dropdown-link" data-test-ref="trigger">
            Dropdown List
          </span>
          <template #dropdown>
            <g-dropdown-menu ref="menu">
              <g-dropdown-item>Item</g-dropdown-item>
            </g-dropdown-menu>
          </template>
        </g-dropdown>
    ...
    test('GButton trigger has proper attributes', async () => {
      const wrapper = _mount(
        `
        <g-dropdown>
          <g-button ref="trigger">
            Dropdown List
          </g-button>
          <template #dropdown>
            <g-dropdown-menu ref="menu">
    ...
    test('Split button trigger has proper attributes', async () => {
      ...
      await nextTick()
      const trigger = wrapper.find('.g-dropdown__caret-button')
      const menu = wrapper.findComponent({ ref: 'menu' })
      expect(trigger.attributes()['role']).toBe('button')
      expect(trigger.attributes()['tabindex']).toBe('0')
      expect(trigger.attributes()['aria-haspopup']).toBe('menu')
    ...
    test('Menu items with "menu" role', async () => {
      const wrapper = _mount(
        ...
        <g-dropdown split-button>
          <template #dropdown>
            <g-dropdown-menu ref="menu">
              <g-dropdown-item ref="menu-item">Item</g-dropdown-item>
            </g-dropdown-menu>
          </template>
        </g-dropdown>
        `,
      ...
      const menu = wrapper.findComponent({ ref: 'menu' })
      const menuItem = menu.find('.g-dropdown-menu__item')
    ...
    test('Menu items with "navigation" role', async () => {
      const wrapper = _mount(
        `
        <g-dropdown split-button role="navigation">
          <template #dropdown>
            <g-dropdown-menu ref="menu">
              <g-dropdown-item ref="menu-item">Item</g-dropdown-item>
            </g-dropdown-menu>
    ...
    test('Menu items with "group" role', async () => {
      const wrapper = _mount(
        `
        <g-dropdown split-button role="group">
          <template #dropdown>
            <g-dropdown-menu ref="menu">
              <g-dropdown-item ref="menu-item">Item</g-dropdown-item>
            </g-dropdown-menu>
    ...
    test('Trigger dropdown via hover', async () => {
      const wrapper = _mount(
        `
        <g-dropdown trigger="hover" :show-timeout="0" :hide-timeout="0">
          <span class="g-dropdown-link">
            Dropdown List
          </span>
          <template #dropdown>
            <g-dropdown-menu ref="menu">
              <g-dropdown-item class="item-1" disabled>Item</g-dropdown-item>
              <g-dropdown-item class="item-2">Item</g-dropdown-item>
              <g-dropdown-item class="item-3">Item</g-dropdown-item>
            </g-dropdown-menu>
          </template>
        </g-dropdown>
        `,
      ...
      const trigger = wrapper.find('.g-tooltip__trigger')
    ...
    test('Trigger dropdown via click', async () => {
      const wrapper = _mount(
        `
        <g-dropdown trigger="click" :show-timeout="0" :hide-timeout="0">
          <span class="g-dropdown-link">
            Dropdown List
          </span>
          <template #dropdown>
    ...
    test('Trigger dropdown via focus', async () => {
      const wrapper = _mount(
        `
        <g-dropdown trigger="focus" :show-timeout="0" :hide-timeout="0">
          <span class="g-dropdown-link">
            Dropdown List
          </span>
          <template #dropdown>
  ...
  describe('teleported API', () => {
    ...
    test('should not mount on the popper container', async () => {
      ...
      _mount(
        `
        <g-dropdown ref="b" placement="right" :teleported="false">
          <span class="g-dropdown-link" ref="a">
            dropdown<i class="g-icon-arrow-down el-icon--right"></i>
          </span>
          <template #dropdown>
    ...
    test('should mount the dropdown popper under append-to', async () => {
      ...
      _mount(
        `
        <g-dropdown append-to=".target_desu">
          <span class="g-dropdown-link">
            dropdown<i class="g-icon-arrow-down el-icon--right"></i>
          </span>
          <template #dropdown>
...
`,
      ...
      expect(
        document
          ...
          ?.children[0].classList.contains('g-popper')
      ).toBe(true)
    })
  })
  ...
  test('hover trigger: click dropdown-item should close immediately', async () => {
    const wrapper = _mount(
      `
      <g-dropdown trigger="hover" :hide-timeout="3000">
        <span class="g-dropdown-link">
          dropdown<i class="g-icon-arrow-down el-icon--right"></i>
        </span>
        <template #dropdown>
          <g-dropdown-menu ref="menu">
            <g-dropdown-item ref="item">Apple</g-dropdown-item>
          </g-dropdown-menu>
        </template>
      </g-dropdown>
      `,
