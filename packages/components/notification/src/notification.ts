...
export interface NotificationProps {
  ...
  /**
   * @description offset from the edge of the screen. Top positions use the top edge and bottom positions use the bottom edge. Every Notification instance of the same position should have the same offset
   */
  offset?: number
  /**
