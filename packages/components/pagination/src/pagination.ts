...
export const paginationEmits = {
  ...
  sizeChange: (val: number) => typeof val === 'number',
  currentChange: (val: number) => typeof val === 'number',
  prevClick: (val: number) => typeof val === 'number',
  nextClick: (val: number) => typeof val === 'number',
}
