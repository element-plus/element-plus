<template>
  <transition :name="transitionName">
    <div v-if="actualVisible || visible" :class="timePanelPrefixClass">
      <div
        :class="{ 'has-seconds': showSeconds, [`${timePanelPrefixClass}__content`]: true }"
      >
        <time-spinner
          ref="spinner"
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const transitionName = computed(() => {
      return props.actualVisible === undefined ? `${zoomPrefixClass.value}-in-top` : ''
    })
