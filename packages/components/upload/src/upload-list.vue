    ...
    >
      <slot :file="file">
        <img
          ...
          alt=""
        />
        <a :class="`${uploadPrefixClass}-list__item-name`" @click="handleClick(file)">
          <el-icon :class="`${iconPrefixClass}--document`"><document /></el-icon>
          {{ file.name }}
        </a>
        ...
        >
          ...
          >
            <el-icon :class="`${iconPrefixClass}--zoom-in`"><zoom-in /></el-icon>
          </span>
          <span
            v-if="!disabled"
