...
const Loading = function (options: ILoadingOptions = {}): ILoadingInstance {
   ...
   * because if a fullscreen loading is trigger when somewhere
   * use v-loading.body and it's parent is document.body which
   * with a margin, the fullscreen loading's destroySelf function
   * will remove 'el-loading-parent--relative', and then the position
   * of v-loading.body will be error.
   */
