...
interface StoreStates {
  ...
  originColumns: Ref<TableColumn[]>
  columns: Ref<TableColumn[]>
  fixedColumns: Ref<TableColumn[]>
  rightFixedColumns: Ref<TableColumn[]>
  leafColumns: Ref<TableColumn[]>
  fixedLeafColumns: Ref<TableColumn[]>
  rightFixedLeafColumns: Ref<TableColumn[]>
