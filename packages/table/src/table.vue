...
export default defineComponent({
  ...
  setup(props: TableProps) {
    ...
    /**
       * open functions
       */
    const { setCurrentRow, toggleRowSelection, clearSelection, clearFilter, toggleAllSelection, toggleRowExpansion, clearSort, doLayout, sort } = useUtils(store, layout, shouldUpdateHeight)
    const {
      isHidden,
      renderExpanded,
      setDragVisible,
