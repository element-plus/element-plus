...
import ConfigProvider from '@element-plus/components/src/config-provider'
import { CommonPicker } from '@element-plus/components/src/time-picker'
import Input from '@element-plus/components/src/input'
import zhCn from '@element-plus/locale/src/lang/zh-cn'
import enUs from '@element-plus/locale/src/lang/en'
import 'dayjs/locale/zh-cn'
import { EVENT_CODE } from '@element-plus/constants'
import { ElFormItem } from '@element-plus/components/src/form'
