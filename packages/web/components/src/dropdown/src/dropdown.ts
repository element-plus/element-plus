...
import { createCollectionWithScope } from '@element-plus/components/src/collection'
import {
...
import type {
  ButtonProps,
  ButtonType,
} from '@element-plus/components/src/button'
import type { Placement } from '@element-plus/components/src/popper'
