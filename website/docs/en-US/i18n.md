...
Using this way is basically implementing a [ConfigProvider](/#/en-US/component/config-provider) on your own to inject configurations.
...
Element Plus use date time locale (month name, first day of the week ...) from [Day.js](https://day.js.org/) directly. And will set the global Day.js locale automatically after the locale file is loaded.
