...
| expand-on-highlight-node  | whether to expand or collapse node when highlighting on the node, if false, then expand or collapse node only when clicking on the arrow icon. | boolean | — | true |
