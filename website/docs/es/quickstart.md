...
Proporcionamos un [plugin de Element](https://github.com/element-plus/vue-cli-plugin-element-plus) para vue-cli@3, que puede utilizar para construir rápidamente un proyecto basado en Element.
