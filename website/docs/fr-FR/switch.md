...
| ----| ----| ----| ----|---- |
| value / v-model | La valeur liée. Elle doit être équivalente à une `active-value` ou une `inactive-value`, par défaut c'est un type `boolean`. | boolean / string / number | — | — |
